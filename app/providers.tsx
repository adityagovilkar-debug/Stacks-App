...
// Persist the query cache to IndexedDB so the library is readable offline and
// a flaky connection doesn't lose your list. Writes made while offline are
